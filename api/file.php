...
// code-examtype-year[-n].pdf, all uppercase dept/code. Validate BEFORE
// the path touches the filesystem — same rule as safe_id() in lib.php.
if (!preg_match('#^[A-Z0-9]+/[A-Z0-9]+/[a-z0-9-]+\.pdf$#', $path)) fail(404, 'Not found');
